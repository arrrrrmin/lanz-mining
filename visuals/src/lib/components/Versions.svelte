<script>
    import projectVersions from "$lib/version";
...
<dl class="pb-6">
    ...
    {#each projectVersions as version}
        ...
        {/if}
        <div class="mt-2 flex w-full flex-none gap-x-2">
            <dt class="flex-none">
            ...
            <dd class="text-sm/6 text-stone-500">
                <time datetime={version.date.toLocaleDateString("de-DE")}
                    >{version.date.toLocaleDateString("de-DE")}</time
                >
            </dd>
        </div>
